  ...
  return (
    <div className="w-full p-6 rounded-[16px] border border-[#C3C1C1] bg-white">
      ...
      <div className="flex flex-col gap-y-4 py-6">
        <div className="flex justify-between items-center p-4 rounded-[8px] border border-[#C3C1C1]">
          <p className="text-[18px] xl:text-[20px] text-paragraph tracking-[-0.6px]">
            Send email
          </p>
          <Clipboard color={"#696969"} />
        </div>
...
export default QuickActionsCompany